package agencesVoyages.src.launch;
...
public class LaunchSimu {
    ...
    public static void main(String... args) {
        ...
        lesAgents.append("client1:agencesVoyages.src.agents.TravellerAgent;");
        lesAgents.append("agentCar:agencesVoyages.src.agents.AgenceAgent(car.csv);");
        lesAgents.append("agentBus:agencesVoyages.src.agents.AgenceAgent(bus.csv);");
        lesAgents.append("agentTrain:agencesVoyages.src.agents.AgenceAgent(train.csv);");
        lesAgents.append("alert1:agencesVoyages.src.agents.AlertAgent");
