package agencesVoyages.src.agents;

import agencesVoyages.src.comportements.ContractNetVente;
import agencesVoyages.src.data.Journey;
import agencesVoyages.src.data.JourneysList;
import agencesVoyages.src.launch.LaunchSimu;
...
public class AgenceAgent extends GuiAgent {
     ...
     */
    private agencesVoyages.src.gui.AgenceGui window;
    /**
    ...
    protected void setup() {
        ...
        window = new agencesVoyages.src.gui.AgenceGui(this);
        window.display();
    ...
    ///// GETTERS AND SETTERS
    public agencesVoyages.src.gui.AgenceGui getWindow() {
        return window;
    }
